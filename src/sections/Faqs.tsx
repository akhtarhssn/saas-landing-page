    ...
    return (
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium text-center mt-6 max-w-xl mx-auto">Questions? We&apos;ve
                    got <span className="text-lime-400">asnwers</span></h2>
                            ...
                            <div key={index} className="bg-neutral-900 rounded-2xl border border-white/10 p-6">
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        className={twMerge("feather feather-plus text-lime-400 flex-shrink-0 transition duration-300", selectedIndex === index && "rotate-45")}>
